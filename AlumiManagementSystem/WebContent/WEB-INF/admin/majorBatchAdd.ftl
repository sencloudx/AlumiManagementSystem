<div class="controltitle">当前操作：excel批量导入专业</div>
<div> 
<form action="majorExcelUploadAction.action" method="post" enctype="multipart/form-data" id="uploadInfor"
		onSubmit="return validateuploadInforFile(this);">
			<input type="file" name="uploadExcel">
			<input type="submit" value="提交"/><a href = "download/majorExcel.xls">[点击下载excel样例]</a>
</form>
</div>
<div>
