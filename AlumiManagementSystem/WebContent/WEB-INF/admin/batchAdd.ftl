...
<div>
	...
	<table class="tablefirst" id="radioSubStyle">
		<tr>
			<th>姓名</th><th>学号</th><th>性别</th><th>籍贯</th><th>专业</th><th>入学年份</th>
			<th>毕业年份</th><th>就业省市</th><th>工作单位</th><th>工作岗位</th><th>职务职称</th>
			<th>电话</th><th>手机</th><th>qq</th><th>身份证号码</th><th>邮箱</th><th>通信地址</th><th>家庭地址</th>
		</tr>
		<tr>
			<td>张三</td><td>1006010054</td><td>男</td><td>汉</td><td>微电子</td><td>2009-11-11</td>
			<td>2011-11-11</td><td>浙江</td><td>熊猫电子</td><td>设计部</td><td>经理</td>
			<td>025-8888888</td><td>15988888888</td><td>888888</td><td>8888888888888888</td><td>test@qq.com</td><td>杭州</td><td>杭州</td>
		</tr>
	</table>
	<div><font color="red">注：①excel各列的顺序必须按样式的顺序，而内容可依实际内容而定；这里不支持照片的导入，照片可在修改中进行上传②性别只能为‘男’与‘女’，校友类型分3类：“普通校友”，“联络员”，“理事”；③专业和班级只能填写数字，具体需要可参见下面的对应表；否则会影响后面的查询。也可以下载系统提供的Excel样例模板。</font></div>
</div>
<div id="excelUploadMsg"></div>
<div>以下是班级和专业的数字与名字对应表</div>
<div class="reference_value">
